...
<head>
    ...
    <title>GuruLink - @yield('title')</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <script src="https://unpkg.com/@phosphor-icons/web"></script>
    <style>
        body { font-family: 'Poppins', sans-serif; }
        /* Utility untuk scrollbar halus */
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between hidden md:flex z-10">
        ...
        <div class="p-4 border-t border-gray-100">
            ...
            <button class="w-full border border-gray-300 rounded-lg py-2 text-sm text-gray-600 hover:bg-gray-50">Keluar</button>
        </div>
    </aside>
